...
var PPS201WetWeight = /** @class */ (function () {
  // Declare the variables
 
  function PPS201WetWeight(args) {
    this.controller = args.controller;
    this.log = args.log;
    this.scriptName = "PPS201WetWeight.js";
  }
  /**
     * Script initialization function.
     */
  PPS201WetWeight.Init = function (args) {
    this.controller = args.controller;
    new PPS201WetWeight(args).run(args);
  };
  PPS201WetWeight.prototype.run = async function (args) {
        debugger;
