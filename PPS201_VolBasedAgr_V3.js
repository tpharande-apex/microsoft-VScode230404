...
var PPS201_VolBasedAgr_V3 = /** @class */ (function () {
    function PPS201_VolBasedAgr_V3(scriptArgs) {
    ...
    PPS201_VolBasedAgr_V3.Init = function (args) {
        new PPS201_VolBasedAgr_V3(args).run();
    };
    PPS201_VolBasedAgr_V3.prototype.run = function () {
        // Get panel details
        ...
        if (this.currentPanel === "PPA201E0") {
            ...
            if (InstanceCache.ContainsKey(this.controller, "Flag") && this.panelMode == 2) {
                ...
                var tempQty = InstanceCache.Get(this.controller, "TempQty");
                  var purprice = InstanceCache.Get(this.controller, "TempPurPrice");
                    var agrNumb = InstanceCache.Get(this.controller, "tempAgrDetails");
    ...
    PPS201_VolBasedAgr_V3.prototype.attachEvents = function (controller) {
        var _this = this;
        this.unsubscribeRequesting = controller.Requesting.On(function (e) {
            ...
            if (((e.commandType === "KEY" && e.commandValue === "ENTER") || (e.commandValue === "F3")) && (_this.currentPanel === "PPA201E0") && _this.Counter == 0) {
                _this.agrnum = _this.controller.GetValue("WBOURR");
                 _this.purprice = _this.controller.GetValue("WBPUPR");
                ...
                if (_this.panelMode == 2) {
                    ...
                    var AgrDetails = _this.Ag
                    InstanceCache.Add(_this.controller, "TempQty", _this.NewQty);
                    InstanceCache.Add(_this.controller, "Flag", flag);
                    InstanceCache.Add(_this.controller, "tempAgrDetails",  _this.agrnum);
                    InstanceCache.Add(_this.controller, "TempPurPrice",  _this.purprice);
                }
    ...
    PPS201_VolBasedAgr_V3.prototype.callmethod = function () {
    ...
    PPS201_VolBasedAgr_V3.prototype.LstAgrNum = function (PONum, controller) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    PPS201_VolBasedAgr_V3.prototype.GetAgrNum = function (supplier, PONum, POline, POSubline, controller) {
        return __awaiter(this, void 0, void 0, function () {
            var responsevalue;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    PPS201_VolBasedAgr_V3.prototype.callApi = function (SUNO, AGRNUM, controller) {
        return __awaiter(this, void 0, void 0, function () {
                            ...
                            if (this.currentPanel === "PPA201E0") {
                                ...
                                if (this.panelMode == 2) {
                                    ...
                                    if ((parseFloat(this.prevQty) + parseInt(tempBalQty)) < parseFloat(this.NewQty)) {
                                        ...
                                        this.controller.SetValue("WBOURR", this.agrnum);
                                        console.log("WBQRA" + this.controller.GetValue("WBORQA") + "Agreenum: " +this.controller.GetValue("WBOURR") );
                                        this.controller.PressKey("F5");
                                    }
                                    else {
                                        ...
                                        if (InstanceCache.ContainsKey(this.controller, "Filter") || this.DryWt == 1) {
                                            ...
                                            var TempPurPrice =  this.controller.GetValue("WBPUPR");
                                            ...
                                            this.controller.SetValue("WBORQA", tempQuantity);
                                             this.controller.SetValue("WBOURR", this.agrnum);
                                            this.controller.SetValue("WBPUPR", TempPurPrice);
    ...
    PPS201_VolBasedAgr_V3.prototype.ItemCheck = function (item, warehouse, controller) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    PPS201_VolBasedAgr_V3.prototype.updateCUGEX1 = function (SUNO, AgrNo, PurQty, BalQty, controller) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    PPS201_VolBasedAgr_V3.prototype.CUSEX_GetFieldValue = function (Supplier, AgrNumber) {
        var _this = this;
    ...
    PPS201_VolBasedAgr_V3.prototype.CUSEX_UpdFieldValue = function (Supplier, AgrNumber, PurQty, BalQty) {
        var _this = this;
        return new Promise(function (resolve) {
    ...
    PPS201_VolBasedAgr_V3.prototype.PPS200_GetLine = function (PONumber, POLine, POSubline) {
        var _this = this;
        return new Promise(function (resolve) {
    ...
    PPS201_VolBasedAgr_V3.prototype.GetItemType = function (ItemNumber) {
        var _this = this;
        return new Promise(function (resolve) {
    ...
    PPS201_VolBasedAgr_V3.prototype.GetAcqCode = function (ItemNumber, warehouse) {
        var _this = this;
        return new Promise(function (resolve) {
    ...
    PPS201_VolBasedAgr_V3.prototype.PPS200_GetHead = function (PONumber) {
        var _this = this;
        return new Promise(function (resolve) {
    ...
    PPS201_VolBasedAgr_V3.prototype.PPS200_LstLine = function (PONumber) {
        var _this = this;
        return new Promise(function (resolve) {
            var record = { 'CONO': _this.company, 'PUNO': PONumber };
    ...
    PPS201_VolBasedAgr_V3.prototype.GetAgrDetails = function (Supplier, AgrNumber) {
        var _this = this;
        return new Promise(function (resolve) {
    ...
    PPS201_VolBasedAgr_V3.prototype.GetDryWt = function (Supplier, AgrNumber, GrpID, key1, key2, Date, ItemNo) {
        var _this = this;
        return new Promise(function (resolve) {
            var Agrfile = "MPAGRL";
    ...
    PPS201_VolBasedAgr_V3.prototype.UpdUserDef = function (PONum, POline, POSubline, Price, Qty, DryWt) {
        return new Promise(function (resolve) {
            if (POSubline == null) {
                POSubline = 0;
            }
    ...
    PPS201_VolBasedAgr_V3.prototype.detachEventsRequesting = function () {
        this.unsubscribeRequesting();
    };
    return PPS201_VolBasedAgr_V3;
}());
